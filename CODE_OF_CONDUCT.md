...
any other concerns, please notify the project maintainers by
emailing `oscar.valenzuela.b_AT_gmail.com` (replace `_AT_` with
`@`). Once the repository is public, GitHub's private reporting
channels are also acceptable for sensitive matters.
...
in the case of a paid event, where applicable).
...
any other forum or event organized under the project's banner. It
applies to the desktop client, the SDK, and the protocol reference
alike.
